...
WebUI.setText(findTestObject('Page_Glexindo Marketplace/input_Account_username'), 'kmz.inn.act@gmail.com')

WebUI.setEncryptedText(findTestObject('Page_Glexindo Marketplace/input_Password_password'), 'o+tS4OuGt32s9ezZj287yw==')
