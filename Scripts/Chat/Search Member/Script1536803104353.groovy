...
WebUI.click(findTestObject('Page_Glexindo Marketplace - Dashboa/span_Pesan'))

WebUI.setText(findTestObject('Page_Glexindo Marketplace - Dashboa/input_Keluar_form-control'), 'global')
